...
Step 1. Open the [Prysmatic Participation Page](https://prylabs.net/participate) and the [client release page](https://github.com/prysmaticlabs/prysm/releases)

&nbsp;&nbsp;&nbsp; <sub> **NOTE:** The description displayed on the **Participation Page** does not work for Windows. </sub>

Step 2. **Download** the newest versions of the Beaconchain **and** Validator. The version name might have changed due to an update, but the file name should similar (green mark on the picture below).
...
Step 3. Find the files that have been downloaded. Usually located in the "Downloads" folder

Step 4. Open the beaconchain file - **beacon-chain**-v1.0.0-alpha.2-windows-amd64.exe - a **red** warnining should appear. **Click** on "More Info" and then "Run anyway".
...
Step 1. Make sure to have the Validator File as desribed [here, Step 2.](https://github.com/Buttaa/eth2-knowledge-base/blob/howToMultiClient/howToMulticlient.md#windows10)
